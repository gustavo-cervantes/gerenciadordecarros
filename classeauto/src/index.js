    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://apigenerator.dronahq.com/api/RJd-Vfps/gerenciadorcarros")];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://apigenerator.dronahq.com/api/RJd-Vfps/gerenciadorcarros/".concat(id))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error('Erro de conexão / was not ok');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.sent();
                    // testar post
                    return [4 /*yield*/, postData('https://apigenerator.dronahq.com/api/RJd-Vfps/gerenciadorcarros', {
                            "Marca": "Toyota",
                            "Modelo": "Corolla",
                            "Categoria": "Sedan",
                            "Ano": 2024,
